...
<div class="container">
    <div class="row-left">
        ...
        <div class="row"><input class="input" type="date" id="Tanggal_dibuat" name="Tanggal_dibuat"></div>
        <br>

        <div class="row"><label for="">Last Upload at :</label></div>
        <div class="row"><input class="input" type="date" id="Terakhir_edit" name="Terakhir_edit"></div>
        <br>
