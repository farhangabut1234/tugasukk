                ...
                <div class="tambah-komentar" id="">
                    ...
                    <form action="aksi_tambahkomentar.php" method="POST">
                        ...
                        <div style="display: flex; gap: 15px;">
                            <div style="display: none;"><input class="komeninput" type="number" id="Komentar_id" name="Komentar_id" hidden required></div>
                            <div style="display: none;"><input class="komeninput" type="text" id="Fotoid" name="Fotoid" value="<?php echo $data['foto_id'] ?>" hidden required></div>
                            <div style="display: none;"><input class="komeninput" type="number" id="Userid" name="Userid" hidden required></div>
                            <div style="width: 100%;">
